...
module.exports = (resolve, rootDir) => {
  const setupTestsFile = fs.existsSync(paths.testsSetup) ? '<rootDir>/js/setupTests.js' : undefined
  ...
  const config = {
    ...
    transform: {
      ...
      '^(?!.*\\.(js|jsx|mjs|css|json|graphql|gql)$)': resolve('config/jest/fileTransform.js')
    },
